...
const Header = () => {
    ...
    const headerClasses =
        'sticky z-20 top-0 left-0 flex items-center w-full h-[70px] sm:h-20 lg:h-[100px] border-b border-gray bg-black';
    const blockClasses = 'relative flex items-center justify-between w-full h-full max-w-[1064px] px-4 sm:px-5 m-auto';
