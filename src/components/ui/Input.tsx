...
const Input: FC<Props> = forwardRef<HTMLInputElement, Props>(({ className = '', ...props }, ref) => {
    const inputClasses =
        'relative w-full height-btn font-medium rounded-md border border-gray bg-transparent px-5 outline-none placeholder:text-gray2 transition-all duration-300';
