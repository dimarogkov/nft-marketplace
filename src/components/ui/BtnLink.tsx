    ...
    ({ href, target, icon: Icon, btnType = EnumBtn.purple, className = '', ...props }, ref) => {
        ...
        return (
            <Link
                ...
                href={href}
                target={target}
                className={`flex items-center justify-center gap-2 w-full sm:w-fit height-btn font-medium px-4 sm:px-5 md:px-8 rounded-md transition-all duration-300 will-change-transform hover:translate-x-[-2px] hover:translate-y-[-2px] active:translate-x-[2px] active:translate-y-[2px] ${btnLinkClasses[btnType]} ${className}`}
            >
